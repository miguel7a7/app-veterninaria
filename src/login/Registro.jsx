      ...
      <div className="login__content card__shadow">
        ...
        <Formik
          ...
          validate={(valores) => {
            ...
            // validando nombres
            errores = validateNombre(valores, errores);

            // validando apellidos
            errores = validateApellidos(valores, errores);
            ...
            <Form>
              ...
              <div className="form-control">
                ...
                <ErrorMessage
                  name="nombre"
                  component={() => (
                    <div className="form__error">{errors.nombre}</div>
                  )}
                />
              </div>
              <div className="form-control">
                ...
                <ErrorMessage
                  name="apellido"
                  component={() => (
                    <div className="form__error">{errors.apellido}</div>
                  )}
                />
              </div>
              <div className="form-control">
        ...
        <div className="form__cuenta">
          <Link to={'/login'}>
            Ya tienes una cuenta? <span>Ingresa aqui</span>
          </Link>
        </div>
      </div>
    </div>
